...
export const TABLE_NAME_LIST: string[] = [
  "general_features_dq",
  "stores_dq",
  "industry_dq",
...
export const COLUMN_QUESTION_MAP = [
  [
...
// const make = (ass_qs: Question[][]) => {
//   return JSON.stringify(ass_qs.map(q => {
//     return q.map(qs => {
//       return { col: qs.name, question: qs.question}
//     })
//   }))
// }
